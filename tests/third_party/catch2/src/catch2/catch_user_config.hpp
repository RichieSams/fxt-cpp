...
#if defined( _DURANGO ) || defined( _GAMING_XBOX_XBOXONE ) || \
    defined( _GAMING_XBOX_SCARLETT )
...
#if defined( CATCH_CONFIG_COUNTER ) && defined( CATCH_CONFIG_NO_COUNTER )
...
#if defined( CATCH_CONFIG_CPP17_BYTE ) && defined( CATCH_CONFIG_NO_CPP17_BYTE )
...
#if defined( CATCH_CONFIG_GETENV ) && defined( CATCH_CONFIG_NO_GETENV )
...
#if defined( CATCH_CONFIG_USE_ASYNC ) && defined( CATCH_CONFIG_NO_USE_ASYNC )
...
#if defined( CATCH_CONFIG_WCHAR ) && defined( CATCH_CONFIG_NO_WCHAR )
