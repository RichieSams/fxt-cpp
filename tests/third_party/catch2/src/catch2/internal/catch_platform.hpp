...
#elif defined(WIN32) || defined(__WIN32__) || defined(_WIN32) || defined(_MSC_VER) || defined(__MINGW32__) || defined(_DURANGO) || defined( _GAMING_XBOX_XBOXONE ) || defined( _GAMING_XBOX_SCARLETT )
